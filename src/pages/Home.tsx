...
export const Home: React.FC = () => {
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <div className="relative h-[400px] bg-gradient-to-r from-green-600 to-green-400 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="max-w-xl">
            <h1 className="text-5xl font-bold mb-4">Fresh Food, Delivered Fresh</h1>
            <p className="text-xl mb-8">Shop for fresh, high-quality groceries from the comfort of your home.</p>
            <Link to="/products" className="bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors">
              Shop Now
            </Link>
          </div>
        </div>
